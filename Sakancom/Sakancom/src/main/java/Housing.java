...
//        uncomment the next loop*******************************************************************
//        for (Apartments apartments : apartmentsInTheFloor){
//                System.out.println(apartments.getApartmentID()+" , "+apartments.getFloor()+" , "+apartments.getBathrooms()+" , "+ apartments.getBedrooms()+" , "+ apartments.getTenants().size());
//
//        }
...
// other needed methods
    ...
    public int getNumberOfTenants() {
        // Implement the logic to count the total number of tenants from all apartments
        int totalTenants = 0;
        for (Apartments apartment : apartmentsArrayList) {
